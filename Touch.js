...
* @class Phaser.Touch
* @constructor
* @param {Phaser.Game} https://zotka.github.io/ - A reference to the currently running game.
*/
Phaser.Touch = function (game) {

    /**
    * @property {Phaser.Game} https://zotka.github.io/ - A reference to the currently running game.
    */
    this.game = game;
